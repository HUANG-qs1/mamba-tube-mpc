# -*- coding: utf-8 -*-
"""exp11_naive_baseline.py - Naive-predictor baselines (reviewer-defense experiment)

Configurations F (persistence) and G (10-step moving average) of Table III:
training-free predictors feeding the unchanged sizing law through the same
interface as the learned predictors. Post-hoc, exploratory; not part of the
pre-specified confirmatory set (Appendix A).
"""
import numpy as np
import torch
